export const Linode = () => {
  return (
    <svg
      enable-background='new 0 0 506.9 131.5'
      viewBox='0 0 506.9 131.5'
      xmlns='http://www.w3.org/2000/svg'
    >
      <path
        d='m109.7 58.2-18.3-10.1-15.4 9.4-.2 9.6-7.5-4.9-10.2 6.2-.4-10.5-10.5-7 10-5.2c-.1 0 0 1-1.5-34.3l-23.5-11.4-32.2 10 7.2 34.6 10.8 8.4-8.2 3.9 5.3 26.1 7.6 7.1-5.4 3.3 4.2 20.2 16.9 17.9c.1-.1 1.8-1.4 21.8-17.3l-.6-13.7 8.6 7.3c.1-.1 1.8-1.4 17.6-13.9l.6-10.1 6.5 4.5c.1-.1 1.6-1.2 14.3-11.3z'
        fill='#231f20'
      />
      ...
      <path d='m94.5 69 15.1-10.8-18.2-10.1-15.4 9.4zm-26.3 18.8 18.8-13.4-18.6-12.2-18.8 11.5zm-32.7 23.4 23.9-17.1-18.6-15.1-23.5 14.4zm-5.5-37.5 27.8-15.8-20.8-13.9-27.3 13zm-7.3-49.6 33.1-12.7-23.6-11.4-32.2 10z' />
      <g fill='#00a762'>
        <path d='m107.1 76.9c-14 11.1-14.3 11.3-14.2 11.3 1.7-20.1 1.6-19.2 1.6-19.2 16-11.5 15-10.8 15.1-10.8z' />
        <path d='m85.8 93.8c-17.3 13.8-17.6 13.9-17.6 13.9-.2-20.8-.1-19.9 0-19.9 20-14.3 18.7-13.4 18.7-13.4z' />
        <path d='m60.2 114.2c-21.7 17.2-21.9 17.3-21.8 17.3-3.1-20.9-3-20.3-3-20.3 25.5-18.2 23.9-17.1 24-17.1z' />
        <path d='m55.8 11.4c1.5 35.4 1.4 34.3 1.5 34.3-28.7 14.9-29.3 15.2-29.2 15.2-5.5-37.6-5.5-36.8-5.4-36.8z' />
        <path d='m57.8 57.9c1.2 26.8 1 25.9 1.1 25.9-24.8 16.7-25.1 16.8-25 16.8-4-27.6-4-26.9-3.9-26.9z' />
      </g>
